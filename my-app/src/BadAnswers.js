const BadAnswers = ({option, totalAnswers, userNb}) => {
    ...
    return(
        <div >
            ...
            <div class="bg-blue-600 text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded-l-full" style={{background : "#fb545e" , width: `${percent}%`}}>{percent}%</div>
        </div>
